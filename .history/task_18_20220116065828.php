                                ...
                                <div class="panel-content image-gallery">
                                    ...
                                    <?php foreach ($cartoons as $cartoon):?>
                                        <div class="col-md-3 image">
                                            ...
                                            <a class="btn btn-danger" href="task_18_delete.php?id=<?php echo $cartoon['id']; ?>&name=<?php echo $cartoon['name'];?> onclick='return confirm('Are you sure you want to delete this?");'">Delete</a>
                                        </div>
                                    <?php endforeach;?>    
