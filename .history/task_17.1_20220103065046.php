                                ...
                                <div class="panel-content image-gallery">
                                    <div class="row">
                                        <div class="col-md-3 image">
                                            <img src="img/demo/gallery/1.jpg"  width="200" height="100">
                                            <a class="btn btn-danger" href="#" onclick="confirm('Вы уверены?');">Удалить</a>
                                        </div>
                                        <div class="col-md-3">
                                            <img src="img/demo/gallery/2.jpg"  width="200" height="100">
                                            <a class="btn btn-danger" onclick="confirm('Вы уверены?');" href="#">Удалить</a>
                                        </div>
                                        <div class="col-md-3">
                                            <img src="img/demo/gallery/3.jpg"  width="200" height="100">
                                            <a class="btn btn-danger" onclick="confirm('Вы уверены?');" href="#">Удалить</a>
                                        </div>
                                    </div>
                                </div>
